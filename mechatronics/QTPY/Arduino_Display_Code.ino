...
const int GATE_PIN = 9; // set pin number, changed from 0 to 9
const int ROT_PIN = 10; // set pin numnber, changed from 2 to 10
const int DUMP_PIN = 11; // set pin number, changed from 1 to 11
int countA = 0;
int countR1 = 0;
int countR2 = 0;
int countR3 = 0;
